  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.features}>
        <div className={styles.feature} onClick={() => handleCardClick("place_order")}>
        ...
        <div className={styles.feature} onClick={() => handleCardClick("market_analysis")}>
        ...
        <div className={styles.feature} onClick={() => handleCardClick("watchlist")}>
        ...
        <div className={styles.feature} onClick={() => handleCardClick("bot")}>
          <img src="bot2.png" alt="Bot" className={styles.icon} />
          <h2>Access the Bot</h2>
          <p>Get access to the trade bot and download the backtest report for the specific strategy</p>
        </div>
        <div className={styles.feature}  onClick={() => handleCardClick("learning")}>
          <img src="learn2.webp" alt="strategies" className={styles.icon} />
